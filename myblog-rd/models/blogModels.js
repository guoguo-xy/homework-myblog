...
module.exports = {
    ...
    saveComm(inpVal, blogId) {

        return db.query("insert into t_comment set content=?,blog_id=?", [inpVal, blogId]);

    },
    saveBlog(blogTitle, blogContent) {
        return db.query("insert into t_blog set title=?,content=?", [blogTitle, blogContent]);
    }
}